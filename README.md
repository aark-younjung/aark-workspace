...
| **GA4 流量分析** | ✅ 6個摘要數字 | ✅ + 詳細報告頁（趨勢/流量來源/頁面/建議） |
| **GSC 搜尋成效** | ✅ 4個摘要數字 | ✅ + 詳細報告頁（趨勢/關鍵字/機會/建議） |
...
| 日期 | 更新內容 |
|------|----------|
| 2026-05-06 | aivis 從獨立加購收回 Pro 核心：Pro 內含每月 150 次（原 100 次），移除 NT$490/990 獨立訂閱方案，改為超量 Top-up 一次性次數包（+300 次 NT$490 / +800 次 NT$990，不過期）；硬上限 1,000 次/月。決策依據：5 LLM 共識認為 aivis 是 Pro 持續訂閱的核心鉤子，獨立加購會讓用戶「改完 SEO 就退訂」 |
| 2026-05-04 | Pricing 頁全面重構（A+B+C+D 11 區塊）：Hero 痛點問句、社會證明區、痛點教育區、Pro 卡平台支援現況、aivis 強化金句、競品比較簡表、Sticky 早鳥 bar、Sticky bottom CTA（mobile）、Pro CTA 信任三件組、FAQ 恐懼標籤、底部雙路 CTA |
| 2026-05-04 | 定價策略大改版：Pro 年費 NT$14,900 → NT$13,900（22% off）、新增 7 天試用 + 14 天退款雙保證、早鳥從「永久 NT$990」改為「4 週 + 100 名・首年 NT$990」、Agency NT$3,990 → NT$4,990 |
...
| 2026-04-10 | GA4/GSC 詳細報告頁完成（/ga4-report/:id、/gsc-report/:id），含趨勢圖、關鍵字分析、建議引擎 |
| 2026-04-10 | 文章內容分析頁完成（/content-audit），15 項 SEO/AEO 檢測，Pro 解鎖修復建議 |
| 2026-04-10 | FAQ 頁完成（/faq），含 FAQPage JSON-LD Schema |
