        ...
        <div className="mt-24">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-base max-w-2xl mx-auto" style={{ color: T.textMid, lineHeight: 1.7 }}>
              ...
              <span style={{ color: T.aivis }}>再轉成 ChatGPT、Claude、Gemini 看得懂的訊號</span>。
              <br />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
            {[
              ...
              },
              {
                ...
                fullName: '生成引擎優化',
                tag: '推薦層',
                desc: '讓 ChatGPT / Claude / Gemini 主動推薦你。',
        ...
        <div className="mt-16">
          ...
          <div className="space-y-3">
            {[
              ...
              { q: 'SEO、AEO、GEO、E-E-A-T 有什麼不同?', a: 'SEO 讓搜尋引擎找到你;AEO 讓你的內容適合被 AI 直接引用;GEO 打好「AI 讀得到、引用時抓得對」的技術地基;E-E-A-T 建立品牌可信度,影響前三者的評分。四者互補,但它們量的都是「體質」——要知道 AI 實際推不推薦你,得真的去問 AI,那是「AI 曝光監測」在做的事。' },
