          ...
          <div className="max-w-7xl mx-auto px-6 py-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm" style={{ color: T.textMid }}>Generative Engine Optimization — 生成式 AI 引用優化</p>
