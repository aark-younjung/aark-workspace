  ...
  return (
    <PageBg>
      ...
      <div className="relative z-10">
        {/* 頁內標題列：返回箭頭 + AEO 標題 + 網址（取代原獨立 header） */}
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <div className="flex items-center gap-3 flex-wrap">
                ...
                {/* AEO 紫色強調細膠囊（取代原本頂部色條的識別作用） */}
                <span style={{
                  fontSize: 11, fontWeight: 700, letterSpacing: '.06em',
                  padding: '3px 8px', borderRadius: 5,
                  background: `linear-gradient(90deg, ${T.aeo}33, #6366f133)`,
                  color: T.aeo, border: `1px solid ${T.aeo}55`,
                }}>AEO</span>
              </div>
              <p className="text-sm mt-1" style={{ color: T.textMid }}>Answer Engine Optimization — 傳統 Google 問答優化</p>
